...
$lang = array_merge($lang, array(
	...
	'DIGESTS_BLOCK_IMAGES_EXPLAIN'		=> 'Empêche l’affichage des images dans vos résumés, y compris les smileys et les images jointes aux messages ou aux messages privés. Utile pour les connexions lentes, en limitant l’utilisation de la bande passante si nécessaire ou pour les forums actifs utilisant de nombreuses images. Les résumés au format texte n’affichent jamais d’image.',
	...
	'DIGESTS_DISABLED_MESSAGE'			=> 'Pour accéder aux options de cette page, accédez au menu « Options de base » puis sélectionnez un type de résumé',
		'DIGESTS_DISCLAIMER_HTML'			=> '<p><a href="%5$s">Désabonnement en un clic</a></p><p>Vous pouvez aussi modifier ou supprimer votre abonnement aux forums depuis le <a href="%1$sucp.%3$s">Panneau de contrôle de l’utilisateur</a>.</p><p>Si vous avez des questions ou si vous souhaitez nous contacter veuillez adresser votre courriel à <a href="mailto:%4$s?subject=Digests">l’administrateur du forum %2$s</a>.</p>',
...
Si vous avez des questions ou si vous souhaitez nous contacter veuillez adresser votre courriel à l’administrateur du forum : %4$s.',
	...
	'DIGESTS_FILTER_FOES'				=> 'Retirer du résumé les messages émis par les Ignorés',
	...
	'DIGESTS_MIN_SIZE_EXPLAIN'			=> 'Si vous laissez ce champ avec la valeur 0, tous les messages seront inclus dans le résumé, quel que soit le nombre de mots qu’ils contiennent.',
	...
	'DIGESTS_NEW_POSTS_ONLY_EXPLAIN'	=> 'Cette option filtre tout message publié avant la date et l’heure de votre dernière visite sur ce forum. Si vous visitez le forum fréquemment et si vous lisez la plupart des messages, cela évitera l’affichage de messages redondants dans votre résumé. Vous risquez cependant de manquer certains messages de forums que vous n’avez pas lus.',
	...
	'DIGESTS_SELECT_FORUMS_EXPLAIN'		=> 'Veuillez noter que les catégories et les forums affichés sont uniquement ceux que vous êtes autorisés à lire. Le choix des forums est désactivé lorsque vous sélectionnez « Sujets cochés uniquement ». Les forums dont les accès sont protégés par mot de passe ne sont pas affichés et ne peuvent pas être sélectionnés. Si tous les forums sont décochés et si sujet n’est coché, vous devez sélectionner au moins un forum afin de pouvoir soumettre correctement votre paramétrage.<br><br>Les forums dont les noms sont affichés en caractères gras (lorsqu’il y en a) sont ceux que l’administrateur force à afficher dans tous les résumés (autres que les seuls sujets cochés). Vous ne pouvez pas les déselectionner. Les forums dont les noms sont barrés ne sont pas autorisés, par l’administrateur, à être affichés dans un résumé (autres que les seuls sujets cochés) et sont de ce fait décochés.',
	...
	'DIGESTS_SIZE_ERROR'				=> 'Ce champ est obligatoire. Vous devez saisir une valeur positive entière, inférieure ou égale à la valeur maximale autorisée par l’administrateur du Forum. Le maximum autorisé est %u. Si cette valeur est à zéro, il n’y a pas de limitation.',
	...
	'DIGESTS_UNSUBSCRIBE_FAILURE'		=> 'Désolés, mais nous n’avons pas pu vous désabonner de la liste d’envoi des résumés.',
