...
$lang = array_merge($lang, array(
	...
	'DIGESTS_FROM_EMAIL_NAME_EXPLAIN'						=> 'Il s’agit du nom qui apparaîtra en clair dans le champ « De » du logiciel de courriel client de l’utilisateur. Si le champ est laissé vide, il s’identifiera en tant que robot de résumé du forum.',
	...
	'DIGESTS_LOWERCASE_DIGEST_TYPE'							=> 'Fréquence d’envoi (en lettres minuscules) pour le titre du résumé',
	...
	'DIGESTS_REPLY_TO_EMAIL_ADDRESS_EXPLAIN'				=> 'Lorsque les utilisateurs reçoivent un résumé, cette adresse de courriel sera utilisée lorsqu’ils cliquent sur « Répondre ». Si le champ est laissé vide, l’adresse de courriel de contact du forum sera utilisée. Faites attention lorsque vous utilisez une adresse de courriel dont le domaine ne correspond pas à celui sur lequel est hébergé le forum, car votre serveur de messagerie ou ceux des utilisateurs pourraient interpréter le courriel comme étant indésirable.',
