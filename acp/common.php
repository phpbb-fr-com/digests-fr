...
$lang = array_merge($lang, array(
	...
	'DIGESTS_EXCLUDE_FORUMS_EXPLAIN'						=> 'Saisissez le forum_id des forums qui ne doivent pas figurer dans le résumé. Séparez les forum_ids par des virgules. En indiquant 0, aucun forum ne sera exclu. Le forum_id d’un forum correspond à la valeur du paramètre « f » dans le champ de l’URL. Exemple : https://www.example.com/phpBB3/viewforum.php?f=1. Ne pas utiliser de forum_ids qui correspondent à des catégories. <i>Ce réglage est ignoré si l’option « Sujets cochés seulement » est activée par l’utilisateur.</i>',
	...
	'DIGESTS_SHOW_FORUM_PATH_EXPLAIN'						=> 'Lorsque cette option est activée, les noms des catégories et des forums où se trouve un forum vont être affichés. Par exemple : « Catégorie 1 &#8249; Forum 1 &#8249; Catégorie A &#8249; Forum B », en y incluant toute la hiérarchie dans laquelle se trouve le forum. Sinon, seul le nom du forum sera affiché, comme « Forum B » dans l’exemple ci-dessus.',
