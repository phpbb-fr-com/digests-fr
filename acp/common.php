...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DEBUG_EXPLAIN'									=> 'Utilisé pour le débogage technique. Cette fonction permet d’enregistrer certaines informations essentielles au dépannage dans le journal d’administration, telles que les requêtes à la base de données utilisées pour assembler les résumés. Vous devez posséder des compétences en matière de développement pour interpréter ces informations.',
	...
	'DIGESTS_FROM_EMAIL_ADDRESS_EXPLAIN'					=> 'Lorsque les utilisateurs recoivent un résumé, cette adresse électronique va s’afficher dans le champ « De ». S’il est laissé vide, l’adresse électronique du forum sera utilisée par défaut. Faites attention lorsque vous utilisez une adresse électronique dont le domaine ne correspond pas à celui sur lequel est hébergé le forum, car votre serveur de courriels ou ceux des utilisateurs pourraient interpréter le courriel comme étant indésirable.',
	'DIGESTS_FROM_EMAIL_NAME'								=> 'Nom de l’expéditeur du courriel',
	'DIGESTS_FROM_EMAIL_NAME_EXPLAIN'						=> 'C’est le nom qui apparaîtra en clair dans le champ « De » du logiciel de courriel client de l’utilisateur. Si le champ est laissé vide, il s’identifiera en tant que robot de résumé du forum.',
	...
	'DIGESTS_INCLUDE_FORUMS_EXPLAIN'						=> 'Saisissez le forum_id des forums qui doivent figurer dans le résumé. Séparez les forum_id par des virgules. En indiquant 0, aucun forum ne sera inclus. Le forum_id correspond à la valeur du paramètre « f » dans le champ de l’URL du forum. Exemple : http://www.example.com/phpBB3/viewforum.php?f=1. N’utilisez pas de forum_ids qui correspondent à des catégories. <i>Ce réglage est ignoré si l’option « Sujets cochés seulement » est activée par l’utilisateur.</i>',
	'DIGESTS_LAST_SENT'										=> 'Dernier résumé envoyé',
	'DIGESTS_LIST_USERS' 								=> array(
																	1	=>	'%d Utilisateur',
																	2	=>	'%d Utilisateurs',
																),
	'DIGESTS_LOWERCASE_DIGEST_TYPE'							=> 'Indiquez la fréquence d’envoi pour le titre du résumé en lettres minuscules',
	'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'Le titre du résumé sera par exemple « Forum x : résumé quotidien », avec la première lettre de la fréquence d’envoi en minuscule.',
	...
	'DIGESTS_MAILER_SPOOLED'								=> 'Tous les résumés créés pour la date et l’heure ont été enregistrés dans le répertoire store/phpbbservices/digests.',
	...
	'DIGESTS_RUN_TEST_CLEAR_SPOOL'							=> 'Effacer le répertoire store/phpbbservices/digests',
	'DIGESTS_RUN_TEST_CLEAR_SPOOL_ERROR'					=> 'Impossible de purger tous les fichiers dans le répertoire store/phpbbservices/digests. Cela peut être dû à des permissions insuffisantes ou parce que le répertoire a été supprimé. Le répertoire doit être accessible en écriture (777 sur les systèmes de type Unix).',
	...
	'DIGESTS_SELECT_FORUMS_ADMIN_EXPLAIN'					=> 'Seuls les forums que l’utilisateur est autorisé à lire sont affichés dans la liste. Si vous souhaitez donner aux utilisateurs des accès à d’autres forums, étendez leur permission d’utilisateur du forum ou de groupe. Notez que vous pouvez aussi ajuster les forums qui apparaissent dans leur résumé. Si leur type de résumé est « Aucun », aucun résumé ne leur sera envoyé.',
	...
	'DIGESTS_SHOW_FORUM_PATH_EXPLAIN'						=> 'Lorsque cette option est activée, les noms des catégories et des forums où se trouve un forum vont être affichés. Par exemple : « Catégorie 1 &#8249; Forum 1 &#8249; Catégorie A &#8249; Forum B », en y incluant toute la hiérarchie dans laquelle se trouve le forum. Sinon, seul le nom du forum sera affiché, comme « Forum B » dans l’exemple.',
