...
$lang = array_merge($lang, array(
	...
	'DIGESTS_BASED_ON'										=> '(Fondée sur UTC%+d)',
	...
	'DIGESTS_CLEAR_REPORT_EXPLAIN'							=> 'Supprime tous les rapports statistiques d’envois collectés.',
	...
	'DIGESTS_CREATE_DIRECTORY_ERROR'						=> 'Impossible de créer le dossier %s. Cela peut être dû à des autorisations insuffisantes. Les autorisations du dossier doivent être définies en écriture publique (777 sur les systèmes Unix).',
	...
	'DIGESTS_DEFAULT'										=> 'Abonner uniquement les lignes cochées en utilisant les valeurs par défaut',
	...
	'DIGESTS_ENABLE_LOG_EXPLAIN'							=> 'Lorsque l’option est activée, toutes les actions réalisées par Digests seront enregistrées dans le journal d’administration (qui se trouve dans l’onglet Maintenance). Permet de répondre aux questions concernant l’envoi des résumés, car il décrit ce qu’a fait le générateur de courriels, quand et pour quels abonnés. Cependant, son activation va rapidement générer de volumineux journaux d’administration, deux entrées au moins étant enregistrées chaque heure dans le journal. <em>Note</em> : les erreurs, les exceptions et les alertes sont toujours inscrites dans le journal de phpBB.',
	'DIGESTS_ENABLE_SUBSCRIBE_UNSUBSCRIBE'					=> 'Activer l’abonnement ou le désabonnement groupé d’utilisateurs',
	'DIGESTS_ENABLE_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'			=> 'Si vous choisissez Oui, lorsque vous cliquerez sur le bouton Envoyer, une action d’abonnement ou de désabonnement groupé d’utilisateurs va être déclenchée. Activez cette option avec précaution !',
	'DIGESTS_EXCLUDE_FORUMS'								=> 'Toujours exclure les forums suivants',
	'DIGESTS_EXCLUDE_FORUMS_EXPLAIN'						=> 'Saisissez le forum_id des forums qui ne doivent pas figurer dans le résumé. Séparez les forum_ids par des virgules. En indiquant 0, aucun forum ne sera exclu. Le forum_id d’un forum correspond à la valeur du paramètre « f » dans le champ de l’URL. Exemple : http://www.example.com/phpBB3/viewforum.php?f=1. Ne pas utiliser de forum_ids qui correspondent à des catégories. <i>Ce réglage est ignoré si l’option « Sujets cochés seulement » est activée par l’utilisateur.</i>',
	...
	'DIGESTS_FROM_EMAIL_ADDRESS_EXPLAIN'					=> 'Lorsque les utilisateurs recoivent un résumé, cette adresse électronique va s’afficher dans le champ « De ». S’il est laissé vide, l’adresse électronique de votre forum sera utilisé par défaut. Faites attention lorsque vous utilisez une adresse électronique dont le domaine ne correspond pas à celui sur lequel est hébergé votre forum, car votre serveur de courriels ou ceux des utilisateurs pourraient interpréter le courriel comme étant du courriel indésirable.',
	'DIGESTS_FROM_EMAIL_NAME'								=> 'Nom de l’expéditeur du courriel',
	'DIGESTS_FROM_EMAIL_NAME_EXPLAIN'						=> 'C’est le nom qui apparaîtra en clair dans le champ « De » du logiciel de courriel client de l’utilisateur. Si le champ est laissé vide, il s’identifiera en tant que robot de résumé de votre forum.',
	'DIGESTS_HAS_UNSUBSCRIBED'								=> 'S’est désabonné',
	'DIGESTS_HOUR_SENT'										=> 'Heure d’envoi (fondée sur UTC%+d)',
	...
	'DIGESTS_INCLUDE_ADMINS_EXPLAIN'						=> 'Permet d’abonner ou de désabonner les administrateurs en complément des utilisateurs ordinaires.',
	'DIGESTS_INCLUDE_FORUMS'								=> 'Toujours inclure les forums suivants',
	'DIGESTS_INCLUDE_FORUMS_EXPLAIN'						=> 'Saisissez le forum_id des forums qui doivent figurer dans le résumé. Séparez les forum_id par des virgules. En indiquant 0, aucun forum ne sera inclus. Pour déterminer le forum_id d’un forum, observez la valeur du paramètre « f » dans le champ de l’URL. C’est le forum_id. Exemple : http://www.example.com/phpBB3/viewforum.php?f=1. N’utilisez pas de forum_ids qui correspondent à des catégories. <i>Ce réglage est ignoré si l’option « Sujets cochés seulement » est activée par l’utilisateur.</i>',
	'DIGESTS_LAST_SENT'										=> 'Dernier résumé envoyé',
	'DIGESTS_LIST_USERS' 								=> array(
																	1	=>	'%d Utilisateur',
																	2	=>	'%d Utilisateurs',
																),
	'DIGESTS_LOWERCASE_DIGEST_TYPE'							=> 'Indiquez la fréquence d’envoi du résumé en lettres minuscules',
	...
	'DIGESTS_MAILER_RAN_WITH_ERROR'							=> 'Une erreur est survenue avec le générateur de courriels. Un ou plusieurs résumés ont pu être générés avec succès. Les journaux d’administration et d’erreurs phpBB peuvent contenir davantage d’information.',
	...
	'DIGESTS_MAX_CRON_HOURS_EXPLAIN'						=> 'Saisissez zéro (0) afin de traiter chaque heure tous les résumés de la file d’attente, lorsque le générateur de courriels est lancé. Cependant, si votre hébergement est mutualisé, le lancement du générateur de courriel peut lui faire atteindre ses limites et entraîner des erreurs. Cela risque de se produire surtout si vous avez de nombreux abonnés et si l’activité de votre forum est faible. La mise en place d’un <a href="https://wiki.phpbb.com/PhpBB3.1/RFC/Modular_cron#Use_system_cron">service cron</a> est la solution la plus simple pour réduire ce risque et de vous assurer que vos résumés arrivent en temps et en heure.',
	'DIGESTS_MAX_ITEMS'										=> 'Nombre maximum de messages autorisés dans un résumé',
	'DIGESTS_MAX_ITEMS_EXPLAIN'								=> 'Pour des raisons de performances, vous pouvez avoir besoin de définir une limite absolue quant au nombre de messages dans un résumé. Si vous indiquez 0 (zéro) la taille du résumé sera illimitée. Vous pouvez utiliser tout nombre entier de votre choix dans ce champ. Veuillez noter qu’un résumé est contraint par le nombre de messages dans le type de résumé demandé (journalier, hebdomadaire ou mensuel) ainsi que par d’autres critères définis par l’utilisateur.',
	...
	'DIGESTS_REGISTRATION_FIELD_EXPLAIN'					=> 'Lorsque l’option est activée, les utilisateurs peuvent s’abonner au service d’envoi du résumé lorsqu’ils créent leur compte. Les réglages par défaut du forum seront appliqués. La proposition d’abonnement ne s’affiche pas lorsque l’option Abonnement automatique est activé.',
	...
	'DIGESTS_RESET_CRON_RUN_TIME_EXPLAIN'					=> 'La réinitialisation du générateur de courriels entraîne la suppression de tous les résumés stockés dans la file d’attente. Lors de son premier lancement après la réinitialisation, seuls les résumés de l’heure courante seront générés. La réinitialisation peut être utile lorsque vous avez fini de tester les résumés ou si le cron phpBB n’a pas fonctionné depuis un certain temps.',
	...
	'DIGESTS_SHOW_EMAIL_EXPLAIN'							=> 'Si cette option est activée, l’adresse électronique de l’abonné est ajoutée aux entrées du journal d’administration avec son nom d’utilisateur. Ce réglage peut servir en cas de problème avec le générateur de courriels.',
	'DIGESTS_SHOW_FORUM_PATH'								=> 'Afficher le chemin d’accès du forum dans le résumé',
	'DIGESTS_SHOW_FORUM_PATH_EXPLAIN'						=> 'Lorsque cette option est activée, les noms des catégories et des forums où se trouve un forum vont être affichés. Par exemple : « Catégorie 1 &#8249; Forum 1 &#8249; Catégorie A &#8249; Forum B », en y incluant toute la hiérarchie dans laquelle se trouve votre forum. Sinon, seul le nom du forum sera affiché, comme « Forum B » dans l’exemple.',
	...
	'DIGESTS_UNLINK_FOREIGN_URLS_EXPLAIN'					=> 'Supprime les liens vers d’autres domaines dans les résumés. Certains systèmes de messagerie signalent les courriels contenant des liens vers d’autres domaines comme étant du courriel indésirable potentiel. Cela peut entraîner le placement des résumés dans le dossier des indésirables, ou empêcher l’envoi de résumés par le serveur de messagerie sortant.',
	'DIGESTS_UNSUBSCRIBE'									=> 'Désabonner uniquement les lignes cochées',
	...
	'DIGESTS_WEEKLY_DIGESTS_DAY_EXPLAIN'					=> 'Le jour de la semaine utilise l’UTC (Temps Universel Coordonné). En fonction de l’heure souhaitée, les abonnés de l’hémisphère occidental peuvent recevoir leur résumé hebdomadaire un jour plus tôt que prévu.',
