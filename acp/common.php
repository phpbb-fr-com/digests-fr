...
$lang = array_merge($lang, array(
	...
	'DIGESTS_FROM_EMAIL_ADDRESS_EXPLAIN'					=> 'Lorsque les utilisateurs recoivent un résumé, cette adresse électronique va s’afficher dans le champ « De ». S’il est laissé vide, l’adresse électronique de votre forum sera utilisée par défaut. Faites attention lorsque vous utilisez une adresse électronique dont le domaine ne correspond pas à celui sur lequel est hébergé votre forum, car votre serveur de courriels ou ceux des utilisateurs pourraient interpréter le courriel comme étant indésirable.',
	...
	'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'En anglais, le titre du résumé sera par exemple « My board name Daily Digest ». Dans certaines langues, « Daily Digest » précède le nom du forum. En indiquant Oui, la fréquence du résumé apparaîtra ainsi : « Résumé quotidien de mon forum », avec la première lettre de la fréquence d’envoi en minuscule.',
	...
	'DIGESTS_MAX_ITEMS_EXPLAIN'								=> 'Pour des raisons de performances, vous pouvez avoir besoin de définir une limite absolue quant au nombre de messages dans un résumé. Si vous indiquez 0 (zéro) la taille du résumé sera illimitée. Vous pouvez utiliser tout nombre entier de votre choix dans ce champ. Veuillez noter qu’un résumé est contraint par le nombre de messages dans le type de résumé demandé (quotidien, hebdomadaire ou mensuel) ainsi que par d’autres critères définis par l’utilisateur.',
	...
	'DIGESTS_MIGRATE_UNSUPPORTED_VERSION'					=> 'Les mises à niveau des modifications des résumés (pour phpBB 3.0) sont prises en charge depuis les versions 2.2.6 et suivantes. Vous utilisez la version %s. L’extension ne peut pas être déplacée ni installée. Veuillez consulter l’aide sur le forum phpbb.com de discussion sur l’extension.',
