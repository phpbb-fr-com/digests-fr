...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'		=> 'Cette fonction permet aux administrateurs d’abonner ou de désabonner de manière pratique et en une seule fois tous les membres de votre forum. Les paramètres par défaut de Digests sont utilisés pour abonner les membres. Si un membre est déjà abonné au résumé, l’abonnement groupé ne modifiera pas ses paramètres. Il n’est pas possible d’abonner un utilisateur à des forums spécifiques. Les utilisateurs sont systématiquement abonnés à tous les forums qu’ils peuvent lire. <strong>Attention</strong> : en utilisant cette option, les abonnés risquent de ne pas apprécier d’être abonnés ou désabonnés sans leur consentement.',
	...
	'LOG_CONFIG_DIGESTS_NOTIFICATION_ERROR'					=> '<strong>Impossible de notifier %s par courriel la modification de ses paramètres de résumés.</strong>',
