...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS_EXPLAIN'				=> 'Cette page permet de supprimer tous les résumés mis en cache dans le répertoire /store/phpbbservices/digests. Ils peuvent être envoyés par le générateur de courriels manuel, mais représentent une vulnérabilité de sécurité potentielle. Si des fichiers sont affichés, il est recommandé de les supprimer.<br><br>%1$d fichiers au total sont dans le cache. Noms des fichiers : %2$s.<br><br>Vous pouvez également effacer des rapports statistiques générés ici.',
	'ACP_DIGESTS_GENERAL_SETTINGS'							=> 'Réglages généraux',
	'ACP_DIGESTS_GENERAL_SETTINGS_EXPLAIN'					=> 'Cette rubrique présente les réglages généraux de Digests, qui permet de générer un résumé des messages publiés sur votre forum. Veuillez noter que si les résumés doivent être délivrés rigoureusement en temps et en heure, vous devez paramétrer et activer le <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq/2716">Cron système</a> de phpBB. Sinon, dès qu’il y aura trop de trafic sur le forum, les résumés de l’heure courante et des heures passées seront envoyés. Pour plus d’informations, veuillez lire la <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq">FAQ de l’extension Digests.</a>',
	'ACP_DIGESTS_EDIT_SUBSCRIBERS'							=> 'Modifier les abonnés',
	'ACP_DIGESTS_EDIT_SUBSCRIBERS_EXPLAIN'					=> 'Cette page vous permet de voir qui reçoit ou non les résumés et de modifier leurs paramètres individuels d’envoi de résumés.<br><br>Vous pouvez rapidement abonner des utilisateurs avec vos réglages par défaut, ou désabonner des utilisateurs, en cochant les lignes souhaitées, puis en sélectionnant « Abonner uniquement les lignes cochées avec les valeurs par défaut » ou « Désabonner uniquement les lignes cochées » depuis le menu local « Avec la sélection » dans le coin inférieur droit de la page.',
	'ACP_DIGESTS_MASS_SUBSCRIBE_UNSUBSCRIBE'				=> 'Abonnements/Désabonnements groupés',
	'ACP_DIGESTS_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'		=> 'Cette fonction permet aux administrateurs d’abonner ou de désabonner de manière pratique et en une seule fois tous les membres de votre forum. Les réglages par défaut de Digests sont utilisés pour abonner les membres. Si un membre est déjà abonné au résumé, l’abonnement groupé ne modifiera pas ses réglages. Il n’est pas possible d’abonner un utilisateur à des forums spécifiques. Les utilisateurs sont systématiquement abonnés à tous les forums qu’ils peuvent lire. <strong>Attention</strong>: en utilisant cette option, les abonnés risquent de ne pas apprécier d’être abonnés ou désabonnés sans leur consentement.',
	'ACP_DIGESTS_REPORTS'									=> 'Rapport d’envoi',
	'ACP_DIGESTS_REPORTS_EXPLAIN'							=> 'Cette page permet de voir le bilan des résumés envoyés à diverses dates et heures, ainsi que des informations sur les performances. Cliquez sur l’en-tête d’une colonne pour modifier son tri. Cliquez sur le nombre de résumés envoyés ou ignorés d’une ligne pour obtenir des détails sur l’instant où les résumés ont été envoyés ou ignorés pour les abonnés à l’heure en question.',
	...
	'ACP_DIGESTS_TEST_EXPLAIN'								=> 'Cette fonction permet de déclencher manuellement l’émission d’un résumé pour des tests de mise au point et en cas de problème. Vous pouvez également l’utiliser afin de régénérer des résumés pour des heures où ils auraient pu ne pas être envoyés. Seule une heure de résumé est générée et aucune donnée utilisateur n’est modifiée.<br><br> <strong>Abonnés pouvant recevoir les résumés pour l’heure courante :</strong> %s',
	...
	'LOG_CONFIG_DIGESTS_BOARD_DISABLED'						=> '<strong>La tentative de lancement du générateur de courriels de résumés a été interrompue car le forum est désactivé.</strong>',
	...
	'LOG_CONFIG_DIGESTS_CREATE_DIRECTORY_ERROR'				=> '<strong>Impossible de créer le dossier %s. Cela peut être dû à des permissions insuffisantes. Les permissions du dossier doivent être réglées en écriture publique (777 sur les systèmes Unix).</strong>',
	'LOG_CONFIG_DIGESTS_CRITICAL_ERROR'						=> '<strong>Le générateur de courriels des résumés a recontré une erreur inattendue.<br>Erreur numéro : [%1$s]<br>Erreur : %2$s<br>Programme : %3$s Ligne : %4$s</strong>',
	...
	'LOG_CONFIG_DIGESTS_EMAILING_FAILURE'					=> '<strong>Impossible d’envoyer le résumé le %1$s à %2$d h UTC. Temps d’exécution : %3$s sur %4$d secondes autorisées. %5$s Mo de mémoire ont été utilisés. Au total, %6$u résumés ont été envoyés par courriel, %7$u résumés ont été ignorés et %8$u heures ont été traitées avant que générateur de courriels ne soit interrompu.</strong>',
	'LOG_CONFIG_DIGESTS_EMAILING_SUCCESS'					=> '<strong>Envoi des résumés le %1$s à %2$d h UTC. Temps d’exécution : %3$s sur %4$d secondes autorisées. %5$s Mo de mémoire ont été utilisés. Au total, %6$u résumés ont été envoyés par courriel, %7$u résumés ont été ignorés et %8$u heures ont été traitées.</strong>',
	...
	'LOG_CONFIG_DIGESTS_FILE_OPEN_ERROR'					=> '<strong>Impossible d’ouvrir un gestionnaire de fichier pour le dossier %s. Cela est peut-être dû à des permissions insuffisantes. Les permissions de fichier du dossier doivent être réglées en écriture publique (777 sur les systèmes Unix).</strong>',
	'LOG_CONFIG_DIGESTS_FILE_WRITE_ERROR'					=> '<strong>Impossible d’écrire dans le fichier %s. Cela est peut-être dû à des permissions insuffisantes. Les permissions de fichier du dossier doivent être réglées sur écriture publique (777 sur les systèmes Unix).</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_NONE'						=> '<strong>Le résumé n’a PAS été envoyé à %1$s (%2$s) car le réglage de ses filtres et ses préférences font qu’il n’y avait rien à envoyer.</strong>',
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_NONE_NO_EMAIL'			=> '<strong>Le résumé n’a PAS été envoyé à %s car le réglage de ses filtres et ses préférences font qu’il n’y avait rien à envoyer.</strong>',
	...
	'LOG_CONFIG_DIGESTS_MASS_SUBSCRIBE_UNSUBSCRIBE'			=> '<strong>Exécution d’une action d’abonnement ou de désabonnement groupé au résumé</strong>',
	'LOG_CONFIG_DIGESTS_NO_ALLOWED_FORUMS'					=> '<strong>Attention : l’abonné %s n’a aucune permission sur le forum, donc à moins qu’il n’y ait des forums requis, les résumés seront toujours vides.</strong>',
	...
	'LOG_CONFIG_DIGESTS_NOTIFICATION_ERROR'					=> '<strong>Impossible d’envoyer par courriel une notification d’administrateur des résumés générés à %s.</strong>',
	...
	'LOG_CONFIG_DIGESTS_RESET_CRON_RUN_TIME'				=> '<strong>L’heure d’envoi des résumés a été réinitialisée</strong>',
	...
	'LOG_CONFIG_DIGESTS_USER_DEFAULTS'						=> '<strong>Modification des réglages utilisateurs par défaut pour les résumés</strong>',
));
